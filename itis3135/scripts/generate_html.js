document.addEventListener('DOMContentLoaded', () => {
    ...
    function escapeHTML(str) {
     ...
     htmlButton.addEventListener('click', () => {
        ...
        const mascotAdjective = "Heroic";
        const mascotAnimal = "Stallion";
        const image = "images/0277.jpeg"; 
        ...
        const subjectBackground = "My academic focus is on Data Sciene and cybersecurity.";
...
<h3>${firstName} "${preferredName}" ${lastName} ★ ${mascotAdjective} ${mascotAnimal}</h3>
<figure>
    <img
        src="${image}"
