document.addEventListener('DOMContentLoaded', () => {
    ...
    jsonButton.addEventListener('click', () => {
     ...
     const links = [
            { name: "GitHub", href: "https://github.com/Hsingh440/" },
            { name: "GitHub Page", href: "https://hsingh440.github.io/" },
            { name: "freeCodeCamp", href: "https://www.freecodecamp.org/hsingh19" },
            { name: "Codecademy", href: "https://www.codecademy.com/profiles/hsingh19charlotte.edu" },
            { name: "LinkedIn", href: "https://www.linkedin.com/in/harry11d/" }
        ];
        ...
        const introData = {
            ...
            "lastName": lastName,
            "divider": "~",
            "mascotAdjective": "Heroic",
            "mascotAnimal": "Stallion",
            "image": "images/0277.png",
            "imageCaption": imageCaption,
            "personalStatement": personalStatement,
            "personalBackground": personalBackground,
            "professionalBackground": professionalBackground,
            "academicBackground": academicBackground,
            "subjectBackground": "My academic focus is on Data Science and cybersecurity.", // Make sure this is what you want!
